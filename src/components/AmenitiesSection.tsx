...
export default function AmenitiesSection() {
  return (
    <section className="bg-[#111111] py-20 lg:py-32" id="amenities">
          ...
          {amenities.map((amenity, index) => (
            ...
            >
              <div className="group relative overflow-hidden aspect-[4/3] cursor-pointer">
                ...
                {/* Icon */}
                <div className="absolute top-6 right-6 w-10 h-10 rounded-full bg-[#C8A96B]/20 flex items-center justify-center text-lg">
                  {amenity.icon}
                </div>
                {/* Content */}
                <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  ...
                  <p
                    className="text-white/60 text-sm leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"

...
const heroSlides = [
  { src: '/images/hero-1.jpg', alt: 'Luxury modern architecture' },
  { src: '/images/hero-2.jpg', alt: 'Premium residential exterior' },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
        ...
        <p
          ref={subtitleRef}
          className="mt-6 md:mt-8 text-white/70 max-w-2xl text-base md:text-lg lg:text-xl leading-relaxed"
        ...
        <a
          ref={ctaRef}
          href="#projects"
          className="mt-10 inline-flex items-center px-10 py-4 bg-[#C8A96B] text-[#111111] font-semibold text-sm tracking-[0.15em] uppercase hover:bg-[#D4B97A] transition-all duration-300 hover-gold-glow"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          Explore Projects
        </a>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2">
        ...
        <div className="animate-bounce">
          <ChevronDown className="text-[#C8A96B]" size={24} />
        </div>
      </div>
    </section>
  );
